	...
	ShaderManager *pShaderManager)
{
	...
	g_pCamera->Position = glm::vec3(1.0f, 10.0f, 10.0f);
	g_pCamera->Front = glm::vec3(0.0f, -2.0f, -5.0f);
...
void ViewManager::scroll_callback(GLFWwindow* window, double xoffset, double yoffset) {
	...
	g_pCamera->MovementSpeed += yoffset * 0.5;

	// Ensure the speed stays within reasonable bounds
	if (g_pCamera->MovementSpeed < 1.5f) {
		g_pCamera->MovementSpeed = 1.5f;
	}
}
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera altitude up & down
